...
const dzikirPetang = ref<DzikirItem[]>([])

onMounted(async () => {
  const res = await import('@/data/dzikir-petang.json')
  dzikirPetang.value = res.dzikir_petang
})
</script>
